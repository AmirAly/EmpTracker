empTracker.controller("LoginController", function ($scope,$filter, $rootScope, $state, $timeout, API, $window, $ionicLoading, $rootScope, $cordovaNetwork, $http, $cordovaToast, LocalStorage) {
    ...
    $scope.$on('$ionicView.enter', function () {
        ...
        //console.log("2017-02-09T10:00:00");
        //console.log(new Date("2017-02-09T10:00:00"));
        //console.log($filter('date')("2017-02-09T10:00:00", 'yyyy-MM-dd'));
        //console.log($filter('date')(new Date("2017-02-09T10:00:00"), 'yyyy-MM-dd'));

        //console.log("2017-02-09T20:00:00");
        //console.log(new Date("2017-02-09T20:00:00"));
        //console.log($filter('date')("2017-02-09T20:00:00", 'yyyy-MM-dd HH:mm'));
        //console.log($filter('date')(new Date("2017-02-09T20:00:00"), 'yyyy-MM-dd HH:mm'));
